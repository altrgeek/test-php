...
class PackagesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('roles.admin.packages.create_packages', compact('packages'));
    }
    ...
    public function store(Request $request)
    {
        ...
        ->with('created', 'The Package has been created');
    ...
    public function show($id)
    {
        ...
        return view('roles.admin.payments.package_payment', compact('transaction'));
    }
