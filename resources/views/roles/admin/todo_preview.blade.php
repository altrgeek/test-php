<x-dashboard title="Task Details">
        <div class="card">
            <div class="card-inner card-inner-xl">
                <div class="entry">
                    ...
                    <div class="row pt-5 pb-6">
                        ...
                        <div class="col-sm-2">
                            @if ($task->status == 'pending')
                                <a href="{{ route('admin.accept',$task->id) }}" class="btn btn-success m-1">Accept</a>
                                <a href="{{ route('admin.reject',$task->id) }}" class="btn btn-danger m-1">Reject</a>
                            @endif
                            @if ($task->status =='accepted')
                            <a href="{{ route('admin.complete',$task->id) }}" class="btn btn-success m-1">Completed</a>
                            @endif
                        </div>
                    </div>
                    </div>
