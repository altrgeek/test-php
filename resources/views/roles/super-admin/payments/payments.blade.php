                                        ...
                                        <tbody class="tb-odr-body">
                                            ...
                                            @foreach ($orders as $order)
                                                <tr class="tb-odr-item">
                                                    <td class="tb-odr-info">
                                                        <span class="tb-odr-id"><a>{{ $order->id ?? 'No orders yet'}}</a></span>
                                                        <span class="tb-odr-id"></span>
                                                        <span class="tb-odr-id"></span>
                                                        <span class="tb-odr-date">{{ $order->created_at ?? 'No orders yet'}}</span>
                                                    </td>
                                                    <td class="tb-odr-amount">
                                                        <span class="tb-odr-total">
                                                            <span class="amount">${{ $order->amount ?? 'No orders yet'}}</span>
                                                        </span>
                                                    ...
                                                    <td class="tb-odr-action">
                                                        <div class="tb-odr-btns d-none d-sm-inline">
                                                            <a href="{{ route('super_admin.dashboard.payments.show', $order->id) }}" class="btn btn-dim btn-sm btn-primary">View</a>
                                                        </div>
                                            ...
                                            @foreach ($subscriptions as $subscription)
                                                <tr class="tb-odr-item">
                                                    <td class="tb-odr-info">
                                                        <span class="tb-odr-id"></span>
                                                        <span class="tb-odr-id"><a>{{ $subscription->id ?? 'No subscriptions yet'}}</a></span>
                                                        <span class="tb-odr-id"></span>
                                                        <span class="tb-odr-date">{{ $subscription->created_at ?? 'No subscriptions yet'}}</span>
                                                    </td>
                                                    <td class="tb-odr-amount">
                                                        <span class="tb-odr-total">
                                                            <span class="amount">${{ $subscription->price ?? 'No subscriptions yet'}}</span>
                                                        </span>
                                                    </td>
                                                    <td class="tb-odr-action">
                                                        <div class="tb-odr-btns d-none d-sm-inline">
                                                            <a href="{{ route('super_admin.dashboard.subscriptions.show', $subscription->subscriptions_id) }}" class="btn btn-dim btn-sm btn-primary">View</a>
                                                        </div>
                                                        <a href="html/invoice-details.html" class="btn btn-pd-auto d-sm-none"><em class="icon ni ni-chevron-right"></em></a>
                                                    </td>
                                                </tr><!-- .tb-odr-item -->
                                            ...
                                            @foreach ($bought_packages as $packages)
                                                <tr class="tb-odr-item">
                                                    ...
                                                    <td class="tb-odr-action">
                                                        <div class="tb-odr-btns d-none d-sm-inline">
                                                            <a href="{{ route('super_admin.dashboard.packages.show', $packages->id) }}" class="btn btn-dim btn-sm btn-primary">View</a>
                                                        </div>
                                                        <a href="html/invoice-details.html" class="btn btn-pd-auto d-sm-none"><em class="icon ni ni-chevron-right"></em></a>
                                                    </td>
                                                </tr><!-- .tb-odr-item -->
