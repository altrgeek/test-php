                                                ...
                                                <tr class="tb-odr-item">
                                                    ...
                                                    <td class="tb-odr-action">
                                                        <div class="tb-odr-btns d-none d-sm-inline">
                                                            <a href="{{ route('client.dashboard.payments.show', $order->id) }}" class="btn btn-dim btn-sm btn-primary">View</a>
                                                        </div>
                                            ...
                                            {{-- retrieveing packages --}}
                                                @foreach ($bought_packages as $packages)
                                                    <tr class="tb-odr-item">
                                                        ...
                                                        <td class="tb-odr-action">
                                                            <div class="tb-odr-btns d-none d-sm-inline">
                                                                <a href="{{ route('client.dashboard.packages.show', $packages->id) }}" class="btn btn-dim btn-sm btn-primary">View</a>
                                                            </div>
                                                            <a href="html/invoice-details.html" class="btn btn-pd-auto d-sm-none"><em class="icon ni ni-chevron-right"></em></a>
                                                        </td>
                                                    </tr><!-- .tb-odr-item -->
