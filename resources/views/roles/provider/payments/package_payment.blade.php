                            ...
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des text-soft">
                                    <ul class="list-inline">
                                        <li>Created At: {{ ($trans->bought_packages->created_at)->format('Y-m-d') }} <span class="text-base"></span></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="nk-block-head-content">
                                <a href="{{ route('provider.dashboard.payments') }}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                                <a href="{{ route('provider.dashboard.payments') }}" class="btn btn-icon btn-outline-light bg-white d-inline-flex d-sm-none"><em class="icon ni ni-arrow-left"></em></a>
                            </div>
                        </div>
                    </div><!-- .nk-block-head -->
                    <div class="nk-block">
                                    ...
                                    <div class="d-block">
                                        <div class="invoice-contact">
                                            ...
                                            <div class="invoice-contact-info">
                                                <h4 class="title">{{ $trans->bought_packages->client->user->name }}</h4>
                                            </div>
                                        </div>
                                        <div class="invoice-contact">
                                            <span class="overline-title">Invoice To</span>
                                            <div class="invoice-contact-info">
                                                <h4 class="title">{{ $trans->bought_packages->client->provider->user->name }}</h4>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="w-60">bought_packages ID</th>
                                                    <th>Amount</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                    <tr>
                                                        ...
                                                        <td>{{ $trans->bought_packages_id }}</td>
                                                        <td>${{ $trans->amount }}</td>
                                                    </tr>
                                            </tbody>
                                        </table>
