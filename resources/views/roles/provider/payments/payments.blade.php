                        ...
                        <div class="nk-block-between g-3">
                            <div class="nk-block-head-content">
                                ...
                                <div class="nk-block-des text-soft"></div>
                                    ...
                                    <p>{{ $client->bought_packages->count() }} packages invoices.</p>
                                    @endforeach
                                </div>
                                ...
                                <div class="card-inner p-0">
                                    ...
                                    id="Admin_Accounts_DataTable" aria-describedby="Admin_Accounts_DataTable_info">
                                        ...
                                        <tbody class="tb-odr-body">
                                            ...
                                            @foreach ($orders as $order)
                                                <tr class="tb-odr-item">
                                                    <td class="tb-odr-info">
                                                        <span class="tb-odr-id"><a>O-id: {{ $order->id }}</a></span>
                                                        <span class="tb-odr-id"></span>
                                                        <span class="tb-odr-id"></span>
                                                        <span class="tb-odr-date">O-date: {{ $order->created_at }}</span>
                                                    </td>
                                                    <td class="tb-odr-amount">
                                                        <span class="tb-odr-total">
                                                            <span class="amount">O-amount: ${{ $order->amount }}</span>
                                                        </span>
                                                        <span class="tb-odr-status">
                                                            @if ($order->status === "unpaid")
                                                            <span class="badge badge-dot badge-warning">O-status: {{ $order->status }}</span>
                                                            @elseif ($order->status === "paid")
                                                            <span class="badge badge-dot badge-success">O-status: {{ $order->status }}</span>
                                                            @endif
                                                        </span>
                                                    </td>
                                                    <td class="tb-odr-action">
                                                        <div class="tb-odr-btns d-none d-sm-inline">
                                                            <a href="{{ route('provider.dashboard.payments.show', $order->id) }}" class="btn btn-dim btn-sm btn-primary">View</a>
                                                        </div>
                                            ...
                                            @foreach ($clients as $client)
                                                @foreach ($client->bought_packages as $packages)
                                                    <tr class="tb-odr-item">
                                                        <td class="tb-odr-info">
                                                            <span class="tb-odr-id"></span>
                                                            <span class="tb-odr-id"><a>P-id: {{ $packages->id }}</a></span>
                                                            <span class="tb-odr-id"></span>
                                                            <span class="tb-odr-date">P-date: {{ $packages->created_at }}</span>
                                                        </td>
                                                        <td class="tb-odr-amount">
                                                            <span class="tb-odr-total">
                                                                <span class="amount">P-amount: ${{ $packages->amount }}</span>
                                                            </span>
                                                        </td>
                                                        <td class="tb-odr-action">
                                                            <div class="tb-odr-btns d-none d-sm-inline">
                                                                <a href="{{ route('provider.dashboard.packages.show', $packages->id) }}" class="btn btn-dim btn-sm btn-primary">View</a>
                                                            </div>
                                                            <a href="html/invoice-details.html" class="btn btn-pd-auto d-sm-none"><em class="icon ni ni-chevron-right"></em></a>
                                                        </td>
                                                    </tr><!-- .tb-odr-item -->
