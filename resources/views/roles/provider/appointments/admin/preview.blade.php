        ...
        <div class="d-flex">
            ...
            @if (!$appointment->isCompleted)
                ...
                @if ($appointment->isRequested && $appointment->isBooked)
                    ...
                    <a href={{ route('provider.dashboard.appointments.admin.edit', $appointment->id) }} type="button"
                        class="btn btn-primary mx-1">
                        <span>Edit</span>
                    </a>
                    {{-- Requested appointments can be deleted if not reviewed yet --}}
                    <form action="{{ route('provider.dashboard.appointments.admin.delete', $appointment->id) }}"
